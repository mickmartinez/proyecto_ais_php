...
;(function($) {
	...
	$.fn.twitterSearch.defaults = {
		...
		colorExterior: '#006699',        // css override of frame border-color and title background-color
		colorInterior: '#ffffff',        // css override of container background-color
		...
		css: {
			...
			text:  {fontWeight: 'normal', fontSize: '11px', color:'#000'},

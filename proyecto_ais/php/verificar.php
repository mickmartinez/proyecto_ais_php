<?php
	...
	$query = mysql_query ("SELECT primer_nombre, primer_apellido, rol FROM usuarios where id = '{$_GET['id']}' and clave = '{$_GET['clave']}'", $db_link);
	...
	if (mysql_num_rows($query)!= 0){
		...
		if ($_SESSION['rol'] == "Taquillero"){
			...
			echo "<form onsubmit = 'buscarPaciente();return false;' action = '' method = 'POST'>
				<strong>CEDULA: </strong><input type='text' id = 'cedula'/>";
